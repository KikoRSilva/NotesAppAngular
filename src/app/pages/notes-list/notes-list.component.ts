...
export class NotesListComponent implements OnInit {
  ...
  ngOnInit(): void {
    // we want to retrieve all notes from Notes Services
  ...
  sortByRelevancy(searchResults: Note[]) {
    // this method will calculate the relevancy of a note based on the number of times it appears in search results
